...
@section('content')
    ...
    <section class="section main-banner" id="top" data-section="section1">
        <video autoplay muted loop id="bg-video">
            <source src="{{ asset('theme/mypage/assets/images/course-video.mp4')}}" type="video/mp4" />
        </video>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="owl-service-item owl-carousel">
                        ...
                        <div class="item">
                            <div class="icon">
                                <img src="{{ asset('theme/mypage/assets/images/service-icon-01.png')}}" alt="">
                            </div>
                        ...
                        <div class="item">
                            <div class="icon">
                                <img src="{{ asset('theme/mypage/assets/images/service-icon-02.png')}}" alt="">
                            </div>
                            <div class="down-content">
                                <h4>Best Teachers</h4>
                                <p>Suspendisse tempor mauris a sem elementum bibendum. Praesent facilisis massa non
                        ...
                        <div class="item">
                            <div class="icon">
                                <img src="{{ asset('theme/mypage/assets/images/service-icon-03.png')}}" alt="">
                            </div>
                            <div class="down-content">
                                <h4>Best Students</h4>
                                <p>Suspendisse tempor mauris a sem elementum bibendum. Praesent facilisis massa non
                        ...
                        <div class="col-lg-6">
                            <div class="meeting-item">
                                <div class="thumb">
                                    ...
                                    <a href="meeting-details.html"><img src="{{ asset('theme/mypage/assets/images/meeting-01.jpg')}}"
                        ...
                        <div class="col-lg-6">
                            <div class="meeting-item">
                                <div class="thumb">
                                    ...
                                    <a href="meeting-details.html"><img src="{{ asset('theme/mypage/assets/images/meeting-02.jpg')}}"
                        ...
                        <div class="col-lg-6">
                            <div class="meeting-item">
                                <div class="thumb">
                                    ...
                                    <a href="meeting-details.html"><img src="{{ asset('theme/mypage/assets/images/meeting-03.jpg')}}"
                        ...
                        <div class="col-lg-6">
                            <div class="meeting-item">
                                <div class="thumb">
                                    ...
                                    <a href="meeting-details.html"><img src="{{ asset('theme/mypage/assets/images/meeting-04.jpg')}}"
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="owl-courses-item owl-carousel">
                        <div class="item">
                            <img src="{{ asset('theme/mypage/assets/images/course-01.jpg')}}" alt="Course One">
                            <div class="down-content">
                        ...
                        <div class="item">
                            <img src="{{ asset('theme/mypage/assets/images/course-02.jpg')}}" alt="Course Two">
                            <div class="down-content">
                        ...
                        <div class="item">
                            <img src="{{ asset('theme/mypage/assets/images/course-03.jpg')}}" alt="">
                            <div class="down-content">
                        ...
                        <div class="item">
                            <img src="{{ asset('theme/mypage/assets/images/course-04.jpg')}}" alt="">
                            <div class="down-content">
                        ...
                        <div class="item">
                            <img src="{{ asset('theme/mypage/assets/images/course-01.jpg')}}" alt="">
                            <div class="down-content">
                        ...
                        <div class="item">
                            <img src="{{ asset('theme/mypage/assets/images/course-02.jpg')}}" alt="">
                            <div class="down-content">
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="video">
                        <a href="https://www.youtube.com/watch?v=HndV87XpkWg" target="_blank"><img
                                src="{{ asset('theme/mypage/assets/images/play-icon.png')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
